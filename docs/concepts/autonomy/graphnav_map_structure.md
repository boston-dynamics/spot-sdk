...
![An extracted point cloud of a real GraphNav map](./images/extract_cloud.png) _An extracted point cloud from a real GraphNav map, viewed in a 3rdparty tool called [CloudCompare](https://www.danielgm.net/cc/)._
