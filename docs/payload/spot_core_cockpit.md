...
However, to test the internet connection, attempt a ping to `google.com`. Press Ctrl + C to exit.
...
Without the gateway, attempt to ping `google.com` from the terminal again. Press Ctrl + C to exit.
