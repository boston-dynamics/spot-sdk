...
example 4.0.2, use the following command.

```shell
$ python3 -m pip install bosdyn-client==4.0.2 bosdyn-mission==4.0.2 bosdyn-choreography-client==4.0.2 bosdyn-orbit==4.0.2
```
...
have bosdyn-api 4.0.2 which is incompatible.
```
