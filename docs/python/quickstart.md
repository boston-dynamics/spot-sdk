...
example 5.1.4, use the following command.

```shell
$ python3 -m pip install bosdyn-client==5.1.4 bosdyn-mission==5.1.4 bosdyn-choreography-client==5.1.4 bosdyn-orbit==5.1.4
```
...
have bosdyn-api 5.1.4 which is incompatible.
```
...
bosdyn-choreography-protos    5.1.4
bosdyn-client                 5.1.4
bosdyn-core                   5.1.4
