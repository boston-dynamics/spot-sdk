...
example 3.1.1, use the following command.

```shell
$ python3 -m pip install bosdyn-client==3.1.1 bosdyn-mission==3.1.1 bosdyn-choreography-client==3.1.1
```
...
have bosdyn-api 3.1.1 which is incompatible.
```
...
bosdyn-api                    3.1.1
bosdyn-choreography-client    3.1.1
bosdyn-choreography-protos    3.1.1
bosdyn-client                 3.1.1
bosdyn-core                   3.1.1
bosdyn-mission                3.1.1
```
**Windows users:**
```shell
