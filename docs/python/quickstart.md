...
example 3.1.2, use the following command.

```shell
$ python3 -m pip install bosdyn-client==3.1.2 bosdyn-mission==3.1.2 bosdyn-choreography-client==3.1.2
```
...
have bosdyn-api 3.1.2 which is incompatible.
```
...
bosdyn-api                    3.1.2
bosdyn-choreography-client    3.1.2
bosdyn-choreography-protos    3.1.2
bosdyn-client                 3.1.2
bosdyn-core                   3.1.2
bosdyn-mission                3.1.2
```
**Windows users:**
```shell
