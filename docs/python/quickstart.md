...
example 5.1.1, use the following command.

```shell
$ python3 -m pip install bosdyn-client==5.1.1 bosdyn-mission==5.1.1 bosdyn-choreography-client==5.1.1 bosdyn-orbit==5.1.1
```
...
have bosdyn-api 5.1.1 which is incompatible.
```
...
bosdyn-api                    5.1.1
bosdyn-choreography-client    5.1.1
bosdyn-choreography-protos    5.1.1
bosdyn-client                 5.1.1
bosdyn-core                   5.1.1
bosdyn-mission                5.1.1
bosdyn-orbit                  5.1.1
```
