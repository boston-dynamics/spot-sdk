...
API example for how to send arm impedance commands with the robot. The example initializes the SDK to talk to robot and commands Spot to stand before
executing the arm impedance control trajectories.
...
```
python3 arm_impedance_control.py ROBOT_IP
```
