...
def force_wrench(config):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        hand_pose1 = odom_T_flat_body * math_helpers.SE3Pose.from_proto(hand_pose1_in_flat_body)
        hand_pose2 = odom_T_flat_body * math_helpers.SE3Pose.from_proto(hand_pose2_in_flat_body)
