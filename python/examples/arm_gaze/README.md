...
An example of commanding a gaze with Spot's arm. The example initializes the SDK to talk to robot and then
requests Spot to stand before executing the arm gaze requests.
...
To run the example:
```
python3 arm_gaze.py --username USER --password PASSWORD ROBOT_IP
```
