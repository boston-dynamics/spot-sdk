...
def run_joint_control(config):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        joint_api_interface = JointAPIInterface(robot, DOF.N_DOF)
        ...
        try:
            ...
            pos_des1 = curr_pose[:]
            pos_des2 = curr_pose[:]
            pos_des1[DOF.A0_WR0] = pos_des1[DOF.A0_WR0] + 1.0
            pos_des1[DOF.A0_F1X] = pos_des1[DOF.A0_F1X] - 0.5
            pos_des2[DOF.A0_WR0] = pos_des2[DOF.A0_WR0] - 1.0
            pos_des2[DOF.A0_F1X] = pos_des2[DOF.A0_F1X] - 0.5

            cmd_poses = [
                curr_pose, pos_des1, curr_pose, pos_des2, curr_pose, pos_des1, curr_pose, pos_des2,
                curr_pose
            ]
            ...
            response = command_streaming_client.send_joint_control_commands(
                joint_api_interface.generate_joint_pos_interp_commands(
                    cmd_poses, curr_load, duration_bw_pose, DEFAULT_K_Q_P, DEFAULT_K_QD_P))
            # print(response)
